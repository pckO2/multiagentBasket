...
class OffensiveAgent(BaseAgent):
    ...
    def build_final_prompt(self, summaries):
        ...
        self.final_prompt  = "Eres un experto ofensivo en baloncesto. Quiero que generes la alineación titular más efectiva posible basada en las estadísticas de los jugadores proporcionados."
        self.final_prompt  += " Quiero que priorices las habilidades ofensivas de los jugadores. En la alineación debes incluir 5 jugadores, uno para cada posición: Base, Escolta, Alero, Ala-Pívot y Pívot."
        ...
        self.final_prompt  += " Considera el rendimiento ofensivo, la química del equipo y las dinámicas de juego al seleccionar la alineación."
